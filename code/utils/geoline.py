...
from utils.operations import compute_mod2, compute_q, wsum, wdiff, kprod, rescale
...
class GeoLine:
	...
	def compute_geodesic(self, from_f:str, to_f:str, N:int=64, method:str='scaled line', verbose:bool=True):
